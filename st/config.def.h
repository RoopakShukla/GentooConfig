...
static char *font = "VictorMonoNerdFontPropo-Semibold:pixelsize=20:antialias=true:autohint=true";
static char *font2[] = { "VictorMonoNerdFontPropo-Semibold:pixelsize=20:antialias=true:autohint=true" };
