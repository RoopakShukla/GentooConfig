...
static const char *fonts[]          = {"VictorMonoNerdFontPropo:style:medium:size=13" ,"VictorMonoNerdFontPropo-Semibold:style:medium:size=19" };
...
static const char* eww[] = { "eww", "-c", "/home/roopa/.config/chadwm/eww", "open" , "eww", NULL };
